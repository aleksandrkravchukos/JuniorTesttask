...
var stringifySafe = __webpack_require__(/*! json-stringify-safe */ "./node_modules/json-stringify-safe/stringify.js");
window.$ = __webpack_provided_window_dot_jQuery = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
var userApp = /*#__PURE__*/function () {
  function userApp() {
  ...
  _createClass(userApp, [{
    ...
    value: function deleteUser() {
      ...
      Swal.fire({
        ...
        preConfirm: function preConfirm(name) {
          if (name) {
            console.log("Entered name: ".concat(name));
          }
        }
    ...
    value: function addUser() {
      var validation = this.validateCreateUser();
      ...
      if (validation === true) {
        ...
        var jsonErrorMessage = stringifySafe(validation);
        Swal.fire({
          icon: icon,
          title: title,
    ...
    key: "makeRequest",
    value: function makeRequest(data) {
      $.ajax({
        url: data.url,
        type: data.method,
        data: data,
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/app"], () => (__webpack_require__("./resources/scss/app.sass")))
